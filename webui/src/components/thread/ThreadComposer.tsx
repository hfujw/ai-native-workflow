...
import type { SendAttachment, SendOptions } from "@/hooks/useLumenStream";
...
const SLASH_RECENTS_STORAGE_KEY = "lumen.webui.slashCommandRecents";
const SLASH_RECENTS_LIMIT = 5;
const QUEUED_PROMPTS_STORAGE_PREFIX = "lumen.webui.composerQueuedGuidance.v1:";
  ...
  return (
    ...
    >
      {goalPanelOpen && canExpandGoal && markdownBody ? (
        <div
          ref={panelRef}
          id="lumen-goal-panel-root"
          role="dialog"
          aria-modal="false"
          aria-labelledby="lumen-goal-panel-title"
          tabIndex={-1}
          className={cn(
          ...
          >
            ...
            {canExpandGoal ? (
              <button
                ...
                aria-controls={goalPanelOpen ? "lumen-goal-panel-root" : undefined}
