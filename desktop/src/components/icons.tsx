...
/** 内联 SVG 图标集 —— 线性描边风格（参照 @deepseek-ai/dsh 的几何图标语法，MIT © 2026 DeepSeek）。
 *  统一 24 viewBox / 1.75 描边 / 圆角端点，color: currentColor 随文本色。 */
...
export const IconPenTool = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconPen = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <path d="M12 20h9" />
...
export const IconShieldCheck = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconPencil = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconMaximize = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconMenu = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconPin = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
/** 面板收起（矩形 + 左侧分隔线 + 向左箭头）——侧边栏折叠按钮，通用惯例图标 */
...
export const IconMinus = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <line x1="5" y1="12" x2="19" y2="12" />
  </svg>
);

export const IconSquare = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <rect x="5" y="5" width="14" height="14" rx="1.5" />
  </svg>
);

export const IconSparkle = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconDatabase = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconGlobe = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconMoon = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z" />
  </svg>
);

export const IconSun = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconMonitor = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconGamepad = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconNewspaper = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconChartBar = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconGrid = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
...
export const IconMessageCircle = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
  </svg>
);

export const IconHistory = ({ size = 16, ...rest }: IconProps) => (
  <svg {...base(size)} {...rest}>
    <circle cx="12" cy="12" r="10" />
